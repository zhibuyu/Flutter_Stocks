...
Data1 _$DataFromJson(Map<String, dynamic> json) {
  return Data1(json['title'] as String, json['time'] as String,
      json['column'] as String, json['url'] as String);
}

Map<String, dynamic> _$DataToJson(Data1 instance) => <String, dynamic>{
